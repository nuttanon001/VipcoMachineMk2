...
namespace VipcoMachine.Models
{
    public class JobCardMaster
    {
        ...
        // JobCardDetail
        public ICollection<JobCardDetail> JobCardDetails { get; set; } = new List<JobCardDetail>();
        // JobCardMasterHasAttach
        public ICollection<JobCardMasterHasAttach> JobCardMasterHasAttachs { get; set; } = new List<JobCardMasterHasAttach>();
    }
